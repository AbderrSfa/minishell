...
SRC = minishell.c start_parsing_pa.c parsing_pa.c check_syntax_pa.c redir_syntax_errors_pa.c init_nodes_pa.c\
	  ...
	  unset_ex.c envp_ex.c get_next_line.c get_next_line_utils.c

PARSING_SRC = allocate_pa.c ambigous_redir_pa.c check_syntax_pa.c env_variable_pa.c free_pa.c init_nodes_pa.c\
